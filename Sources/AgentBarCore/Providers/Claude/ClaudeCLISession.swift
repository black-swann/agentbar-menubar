...
actor ClaudeCLISession {
    ...
    private static let log = AgentBarLog.logger(LogCategories.claudeCLI)
    ...
    private func ensureStarted(binary: String) throws {
        ...
        let disableWatchdog = ProcessInfo.processInfo.environment["AGENTBAR_DISABLE_CLAUDE_WATCHDOG"] == "1"
        if !disableWatchdog,
